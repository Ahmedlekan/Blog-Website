import {
  ...
  const Contact = () => {
    return (
      <div className="sm:mx-auto sm:w-full sm:max-w-[1200px] py-10 md:px-10 ">
        <div className="wrapper bg-gray-50 px-4 py-8 shadow-lg rounded-md sm:px-10">
          ...
          <form className="space-y-6">
            ...
            <textarea
              ...
              rows={10}
            />
            <button className="w-1/2 bg-accent-red p-2 rounded-md text-gray-50 shadow-lg hover:bg-sky-300 duration-500">
              Submit
            </button>
          </form>
        </div>
